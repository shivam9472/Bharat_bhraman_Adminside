...
//        ],
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 10,),
            Text('Welcome to the admin section ',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            SizedBox(height: 10,),
            Card(
              elevation: 0,

              child: Image.network('https://static.vecteezy.com/system/resources/thumbnails/000/512/900/small/122_-_3_-_Under_Maintenance.jpg'),
            ),
          ],
        ),
      ),
